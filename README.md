...
module "kinesis_stream_es" {
    source = "git::https://github.com/EluminaGroup/terraform-aws-kinesis-stream-es.git"
...
Apache 2 Licensed. See [LICENSE](https://github.com/EluminaGroup/terraform-aws-kinesis-stream-es/blob/master/LICENSE) for full details.
